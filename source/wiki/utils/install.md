...
Linux 下将大写锁定键 (CapsLock) 键映射为 Ctrl 键 (Ubuntu, Manjaro，CentOS)
mac book 更改 caps lock 键为 esc 键 /ctrl 键
windows 交换大写锁定键与 ESC 键（注册表修改）
在任何操作系统上，如何禁用或者重新分配 Caps Lock 键
